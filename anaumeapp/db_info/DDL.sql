...
create table fillquestion_detail (
  fillquestion_detail_id serial
  , fillquestion_id integer not null
  , text varchar not null
  , answer_text varchar
  , constraint fillquestion_detail_PKC primary key (fillquestion_detail_id)
) ;

-- 問題文
--* RestoreFromTempTable
create table fillquestions (
  fillquestion_id serial
...
comment on column fillquestion_detail.fillquestion_detail_id is '問題文詳細ID';
